...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      'nav.mobile.database': 'Jugadores',
      'nav.mobile.teams': 'Equipos',
      'nav.mobile.calendar': 'Partidos',
      'nav.mobile.trainings': 'Entrenos',
      'nav.mobile.attendance': 'Asistencia',
      'nav.mobile.transport': 'Transporte',
      ...
      'pos.player': 'Jugador (Sin posición fija)',
      'teams.isInitiation': 'Grupo / Equipo de iniciación (Guarderías / Psicomotricidad)',
      'teams.isInitiationHelp': 'No exige equipación oficial ni material. No se mostrarán alertas de equipación faltante.',
      'teams.badgeInitiation': '🐣 Iniciación',
      'teams.deleteTeam': '🗑️ Eliminar equipo',
      'teams.deleteTeamConfirm': '¿Estás seguro de que deseas eliminar este equipo? Si tiene jugadores, quedarán sin equipo asignado.',
      'teams.deleteTeamSuccess': 'Equipo eliminado con éxito',
      'teams.deleteTrainings': '🗑️ Eliminar entrenamientos',
      'teams.deleteTrainingsConfirm': '¿Deseas eliminar todas las sesiones de entrenamiento de este equipo?',
      'teams.deleteTrainingsSuccess': 'Entrenamientos del equipo eliminados con éxito',
      'teams.noTrainings': 'Este equipo no tiene entrenamientos programados',
      'trainings.timeForDay': 'Horario para',
      'trainings.savedLocations': 'Sedes habituales',
      'matches.selectMatchPrompt': 'Selecciona un partido',
      'matches.selectMatchHelp': 'Elige un partido de la lista para ver su convocatoria y detalles',
      'transport.selectMatchPrompt': 'Selecciona un partido para asignar convocados a esta furgoneta',
      'attendance.title': 'Control General de Asistencia',
      'attendance.subtitle': 'Estadísticas globales por equipo y desglose individual por jugador.',
      'attendance.avgAttendance': 'Asistencia media',
      'attendance.sessionsRatio': 'asistencias totales',
      'attendance.unfoldPlayers': 'Ver jugadores',
      'attendance.foldPlayers': 'Ocultar jugadores',
      'attendance.filterPeriod': 'Periodo',
      'attendance.allSeason': 'Toda la temporada',
      'attendance.quickRoster': '📋 Pasar lista rápida',
      'attendance.playerRate': 'Asistencia:',
      'attendance.sessionsCount': 'sesiones',
      'trainings.manageLocations': '📍 Gestionar ubicaciones',
      'trainings.locationsManagerTitle': '📍 Ubicaciones e Instalaciones Guardadas',
      'trainings.addNewLocation': '➕ Añadir nueva ubicación',
      'trainings.editLocation': 'Editar ubicación',
      'trainings.locationName': 'Nombre del campo / recinto',
      'trainings.locationAddress': 'Dirección o punto de encuentro',
      'trainings.confirmDeleteLocation': '¿Deseas eliminar esta ubicación guardada?',
      'trainings.clearAllLocations': 'Vaciar todas',
      'trainings.resetLocations': 'De fábrica',
      'attendance.todayTrainingsTitle': 'Pasar lista - Entrenamientos de hoy',
      'attendance.noTrainingsToday': 'No hay entrenamientos planificados para hoy',
      'attendance.noTrainingsTodayDesc': 'No hay sesiones de entrenamiento programadas para hoy ({date}).',
      'attendance.pastPendingAlert': '⚠️ Sesiones de días anteriores pendientes de pasar lista',
      'attendance.pastPendingDesc': 'Tienes sesiones de días anteriores en las que aún no se ha registrado la asistencia:',
      'attendance.badgeDone': '✔ Lista pasada',
      'attendance.badgePending': '⏳ Sin pasar lista',
      'attendance.modifyList': '✏️ Modificar lista',
      'attendance.takeList': '📋 Pasar lista',
      'attendance.takeListNow': '📋 Pasar lista ahora',
      'attendance.backToToday': 'Volver a entrenamientos de hoy',
      'ocr.importBtn': 'Importar desde captura',
      'ocr.modalTitle': 'Importar jugador desde captura de pantalla',
      'ocr.dropTitle': 'Arrastra aquí una captura o haz clic para seleccionarla',
      'ocr.dropSub': 'Compatible con capturas de Sportlyzer, fichas federativas y capturas de móvil',
      'ocr.chooseFile': 'Elegir imagen',
      'ocr.pasteClipboard': 'Pegar del portapapeles (Ctrl+V)',
      'ocr.tipKey': 'Consejo rápido:',
      'ocr.tipDesc': 'Haz una captura (Win+Shift+S) y pulsa Ctrl+V directamente en cualquier momento',
      'ocr.detectingFields': 'Extrayendo nombre, dorsal, fecha de nacimiento y contactos...',
      'ocr.dataExtracted': 'Datos extraídos automáticamente. Revisa o ajusta si es necesario:',
      'ocr.scanAnother': 'Escanear otra imagen',
      'ocr.guardianTitle': 'Contacto de Padre / Madre / Tutor',
      'ocr.guardianRel': 'Parentesco',
      'ocr.guardianName': 'Nombre del tutor',
      'ocr.guardianPhone': 'Teléfono de contacto',
      'ocr.guardianEmail': 'Correo electrónico del tutor',
      'ocr.previewNotice': 'Captura escaneada con éxito. Puedes guardar ahora o abrir la ficha para añadir foto y tallas.',
      'ocr.continueToForm': 'Continuar a ficha completa',
      'ocr.saveDirect': 'Guardar jugador',
      'backup.saveBtn': 'Guardar copia',
      'backup.saveBtnTitle': 'Descargar archivo de copia de seguridad con todos los jugadores'
    },
    ...
    en: {
      ...
      'nav.mobile.database': 'Players',
      'nav.mobile.teams': 'Teams',
      'nav.mobile.calendar': 'Matches',
      'nav.mobile.trainings': 'Trainings',
      'nav.mobile.attendance': 'Attendance',
      'nav.mobile.transport': 'Transport',
      ...
      'pos.player': 'Player (Unassigned position)',
      'teams.isInitiation': 'Initiation / Kindergarten group',
      'teams.isInitiationHelp': 'Does not require official kit. No missing kit alerts will be shown.',
      'teams.badgeInitiation': '🐣 Initiation',
      'teams.deleteTeam': '🗑️ Delete team',
      'teams.deleteTeamConfirm': 'Are you sure you want to delete this team? Assigned players will become unassigned.',
      'teams.deleteTeamSuccess': 'Team deleted successfully',
      'teams.deleteTrainings': '🗑️ Delete team trainings',
      'teams.deleteTrainingsConfirm': 'Do you want to delete all training sessions for this team?',
      'teams.deleteTrainingsSuccess': 'Team trainings deleted successfully',
      'teams.noTrainings': 'This team has no scheduled trainings',
      'trainings.timeForDay': 'Schedule for',
      'trainings.savedLocations': 'Saved venues',
      'matches.selectMatchPrompt': 'Select a match',
      'matches.selectMatchHelp': 'Choose a match from the list to view its call-up and details',
      'transport.selectMatchPrompt': 'Select a match to assign players to this vehicle',
      'attendance.title': 'General Attendance Management',
      'attendance.subtitle': 'Team overall statistics and individual player breakdown.',
      'attendance.avgAttendance': 'Average attendance',
      'attendance.sessionsRatio': 'total attendances',
      'attendance.unfoldPlayers': 'View players',
      'attendance.foldPlayers': 'Hide players',
      'attendance.filterPeriod': 'Period',
      'attendance.allSeason': 'Full season',
      'attendance.quickRoster': '📋 Quick attendance list',
      'attendance.playerRate': 'Attendance:',
      'attendance.sessionsCount': 'sessions',
      'trainings.manageLocations': '📍 Manage locations',
      'trainings.locationsManagerTitle': '📍 Saved Locations & Facilities',
      'trainings.addNewLocation': '➕ Add new location',
      'trainings.editLocation': 'Edit location',
      'trainings.locationName': 'Pitch / Venue name',
      'trainings.locationAddress': 'Address or meeting point',
      'trainings.confirmDeleteLocation': 'Do you want to delete this saved location?',
      'trainings.clearAllLocations': 'Clear all',
      'trainings.resetLocations': 'Defaults',
      'attendance.todayTrainingsTitle': 'Take Attendance - Today\'s Trainings',
      'attendance.noTrainingsToday': 'No trainings scheduled for today',
      'attendance.noTrainingsTodayDesc': 'There are no training sessions scheduled for today ({date}).',
      'attendance.pastPendingAlert': '⚠️ Past sessions with pending attendance',
      'attendance.pastPendingDesc': 'You have previous sessions where attendance has not yet been taken:',
      'attendance.badgeDone': '✔ Attendance taken',
      'attendance.badgePending': '⏳ Attendance pending',
      'attendance.modifyList': '✏️ Edit attendance',
      'attendance.takeList': '📋 Take attendance',
      'attendance.takeListNow': '📋 Take attendance now',
      'attendance.backToToday': 'Back to today\'s trainings',
      'ocr.importBtn': 'Import from screenshot',
      'ocr.modalTitle': 'Import player from screenshot',
      'ocr.dropTitle': 'Drop a screenshot here or click to select',
      'ocr.dropSub': 'Compatible with Sportlyzer profiles, federation cards and phone screenshots',
      'ocr.chooseFile': 'Choose image',
      'ocr.pasteClipboard': 'Paste from clipboard (Ctrl+V)',
      'ocr.tipKey': 'Quick tip:',
      'ocr.tipDesc': 'Take a screenshot (Win+Shift+S) and press Ctrl+V directly anytime',
      'ocr.detectingFields': 'Extracting name, player number, birth date and contacts...',
      'ocr.dataExtracted': 'Data extracted automatically. Review or adjust if needed:',
      'ocr.scanAnother': 'Scan another image',
      'ocr.guardianTitle': 'Parent / Guardian Contact',
      'ocr.guardianRel': 'Relation',
      'ocr.guardianName': 'Guardian name',
      'ocr.guardianPhone': 'Contact phone',
      'ocr.guardianEmail': 'Guardian email',
      'ocr.previewNotice': 'Screenshot scanned successfully. You can save now or open full profile to add photo and sizes.',
      'ocr.continueToForm': 'Continue to full profile',
      'ocr.saveDirect': 'Save player',
      'backup.saveBtn': 'Save backup',
      'backup.saveBtnTitle': 'Download backup JSON file with all players'
    },
    ...
    et: {
      ...
      'nav.attendance': 'Osalemine',
      'nav.transport': 'Transport',
      'nav.mobile.database': 'Mängijad',
      'nav.mobile.teams': 'Võistkond',
      'nav.mobile.calendar': 'Mängud',
      'nav.mobile.trainings': 'Treening',
      'nav.mobile.attendance': 'Osalemine',
      'nav.mobile.transport': 'Transport',
      ...
      // Uued funktsioonid ja täiustused
      'pos.player': 'Mängija (Määramata positsioon)',
      'teams.isInitiation': 'Algajate / Lasteaia rühm (Psühhomotoorika)',
      'teams.isInitiationHelp': 'Ametlikku varustust ei nõuta. Puuduva varustuse hoiatusi ei kuvata.',
      'teams.badgeInitiation': '🐣 Algajad',
      'teams.deleteTeam': '🗑️ Kustuta meeskond',
      'teams.deleteTeamConfirm': 'Kas olete kindel, et soovite selle meeskonna kustutada? Mängijad jäävad meeskonnata.',
      'teams.deleteTeamSuccess': 'Meeskond edukalt kustutatud',
      'teams.deleteTrainings': '🗑️ Kustuta meeskonna treeningud',
      'teams.deleteTrainingsConfirm': 'Kas soovite kustutada kõik selle meeskonna treeningud?',
      'teams.deleteTrainingsSuccess': 'Meeskonna treeningud edukalt kustutatud',
      'teams.noTrainings': 'Sellel meeskonnal pole plaanitud treeninguid',
      'trainings.timeForDay': 'Aeg päevale',
      'trainings.savedLocations': 'Salvestatud asukohad',
      'matches.selectMatchPrompt': 'Vali mäng',
      'matches.selectMatchHelp': 'Vali nimekirjast mäng, et näha koosseisu ja üksikasju',
      'transport.selectMatchPrompt': 'Vali mäng, et määrata mängijad sellesse sõidukisse',
      'attendance.title': 'Osalemise Üldjuhtimine',
      'attendance.subtitle': 'Võistkonna üldine statistika ja iga mängija eraldi osalus.',
      'attendance.avgAttendance': 'Keskmine osalus',
      'attendance.sessionsRatio': 'kogu osalemised',
      'attendance.unfoldPlayers': 'Vaata mängijaid',
      'attendance.foldPlayers': 'Peida mängijad',
      'attendance.filterPeriod': 'Periood',
      'attendance.allSeason': 'Terve hooaeg',
      'attendance.quickRoster': '📋 Kiire nimekirja kontroll',
      'attendance.playerRate': 'Osalus:',
      'attendance.sessionsCount': 'treeningut',
      'trainings.manageLocations': '📍 Halda asukohti',
      'trainings.locationsManagerTitle': '📍 Salvestatud asukohad ja rajatised',
      'trainings.addNewLocation': '➕ Lisa uus asukoht',
      'trainings.editLocation': 'Muuda asukohta',
      'trainings.locationName': 'Väljaku / spordihalli nimi',
      'trainings.locationAddress': 'Aadress või kogunemiskoht',
      'trainings.confirmDeleteLocation': 'Kas soovite selle salvestatud asukoha kustutada?',
      'trainings.clearAllLocations': 'Tühjenda kõik',
      'trainings.resetLocations': 'Vaikesätted',
      'attendance.todayTrainingsTitle': 'Võta kohalolek - Tänased treeningud',
      'attendance.noTrainingsToday': 'Tänaseks pole treeninguid planeeritud',
      'attendance.noTrainingsTodayDesc': 'Tänaseks ({date}) pole ühtegi treeningut määratud.',
      'attendance.pastPendingAlert': '⚠️ Varasemad treeningud puuduva kohaloluga',
      'attendance.pastPendingDesc': 'Teil on varasemaid treeninguid, kus kohalolekut pole veel märgitud:',
      'attendance.badgeDone': '✔ Nimekiri võetud',
      'attendance.badgePending': '⏳ Nimekiri võtmata',
      'attendance.modifyList': '✏️ Muuda nimekirja',
      'attendance.takeList': '📋 Võta kohalolek',
      'attendance.takeListNow': '📋 Võta kohalolek kohe',
      'attendance.backToToday': 'Tagasi tänaste treeningute juurde',
      'ocr.importBtn': 'Impordi ekraanipildilt',
      'ocr.modalTitle': 'Impordi mängija ekraanipildilt',
      'ocr.dropTitle': 'Lohista ekraanipilt siia või klõpsa valimiseks',
      'ocr.dropSub': 'Ühildub Sportlyzeri profiilide ja telefonipiltidega',
      'ocr.chooseFile': 'Vali pilt',
      'ocr.pasteClipboard': 'Kleebi lõikelaualt (Ctrl+V)',
      'ocr.tipKey': 'Kiirvihje:',
      'ocr.tipDesc': 'Tee ekraanipilt (Win+Shift+S) ja vajuta otse Ctrl+V',
      'ocr.detectingFields': 'Nime, särginumbri, sünniaja ja kontaktide tuvastamine...',
      'ocr.dataExtracted': 'Andmed tuvastatud. Vaata üle või kohanda vajadusel:',
      'ocr.scanAnother': 'Skanni teine pilt',
      'ocr.guardianTitle': 'Lapsevanema / eestkostja kontakt',
      'ocr.guardianRel': 'Sugulusaste',
      'ocr.guardianName': 'Eestkostja nimi',
      'ocr.guardianPhone': 'Kontaktnumber',
      'ocr.guardianEmail': 'Eestkostja e-post',
      'ocr.previewNotice': 'Pilt skannitud. Salvesta kohe või ava kaart foto ja suuruste lisamiseks.',
      'ocr.continueToForm': 'Jätka täiskaardile',
      'ocr.saveDirect': 'Salvesta mängija',
      'backup.saveBtn': 'Salvesta varukoopia',
      'backup.saveBtnTitle': 'Laadi alla JSON-varukoopia kõigi mängijatega'
    },
    ...
    ru: {
      ...
      'nav.mobile.database': 'Игроки',
      'nav.mobile.teams': 'Команды',
      'nav.mobile.calendar': 'Матчи',
      'nav.mobile.trainings': 'Тренировки',
      'nav.mobile.attendance': 'Посещение',
      'nav.mobile.transport': 'Транспорт',
      ...
      'pos.player': 'Игрок (Без фикс. позиции)',
      'teams.isInitiation': 'Группа начальной подготовки / Детский сад (Психомоторика)',
      'teams.isInitiationHelp': 'Официальная форма не требуется. Предупреждения об экипировке скрыты.',
      'teams.badgeInitiation': '🐣 Начальный',
      'teams.deleteTeam': '🗑️ Удалить команду',
      'teams.deleteTeamConfirm': 'Вы уверены, что хотите удалить эту команду? Игроки останутся без команды.',
      'teams.deleteTeamSuccess': 'Команда успешно удалена',
      'teams.deleteTrainings': '🗑️ Удалить тренировки команды',
      'teams.deleteTrainingsConfirm': 'Удалить все тренировки этой команды?',
      'teams.deleteTrainingsSuccess': 'Тренировки команды успешно удалены',
      'teams.noTrainings': 'У этой команды нет запланированных тренировок',
      'trainings.timeForDay': 'Время для',
      'trainings.savedLocations': 'Сохраненные базы',
      'matches.selectMatchPrompt': 'Выберите матч',
      'matches.selectMatchHelp': 'Выберите матч из списка, чтобы увидеть состав и детали',
      'transport.selectMatchPrompt': 'Выберите матч для распределения мест в автобусе',
      'attendance.title': 'Учёт и Контроль Посещаемости',
      'attendance.subtitle': 'Общая статистика команд и подробный отчет по каждому игроку.',
      'attendance.avgAttendance': 'Средняя посещаемость',
      'attendance.sessionsRatio': 'всего посещений',
      'attendance.unfoldPlayers': 'Игроки',
      'attendance.foldPlayers': 'Скрыть игроков',
      'attendance.filterPeriod': 'Период',
      'attendance.allSeason': 'Весь сезон',
      'attendance.quickRoster': '📋 Отметить посещаемость',
      'attendance.playerRate': 'Посещаемость:',
      'attendance.sessionsCount': 'тренировок',
      'trainings.manageLocations': '📍 Управление локациями',
      'trainings.locationsManagerTitle': '📍 Сохранённые локации и поля',
      'trainings.addNewLocation': '➕ Добавить новую локацию',
      'trainings.editLocation': 'Редактировать локацию',
      'trainings.locationName': 'Название поля / зала',
      'trainings.locationAddress': 'Адрес или место сбора',
      'trainings.confirmDeleteLocation': 'Удалить эту сохранённую локацию?',
      'trainings.clearAllLocations': 'Очистить все',
      'trainings.resetLocations': 'По умолчанию',
      'attendance.todayTrainingsTitle': 'Отметить посещаемость - Тренировки на сегодня',
      'attendance.noTrainingsToday': 'На сегодня тренировок не запланировано',
      'attendance.noTrainingsTodayDesc': 'На сегодня ({date}) тренировочные занятия не запланированы.',
      'attendance.pastPendingAlert': '⚠️ Прошедшие тренировки без отметки посещаемости',
      'attendance.pastPendingDesc': 'У вас есть прошедшие тренировки, где ещё не отмечена посещаемость:',
      'attendance.badgeDone': '✔ Список отмечен',
      'attendance.badgePending': '⏳ Список не отмечен',
      'attendance.modifyList': '✏️ Изменить список',
      'attendance.takeList': '📋 Отметить посещаемость',
      'attendance.takeListNow': '📋 Отметить сейчас',
      'attendance.backToToday': 'Назад к сегодняшним тренировкам',
      'ocr.importBtn': 'Импорт со скриншота',
      'ocr.modalTitle': 'Импорт игрока со скриншота',
      'ocr.dropTitle': 'Перетащите скриншот сюда или кликните для выбора',
      'ocr.dropSub': 'Поддерживает профили Sportlyzer и скриншоты с телефона',
      'ocr.chooseFile': 'Выбрать изображение',
      'ocr.pasteClipboard': 'Вставить из буфера (Ctrl+V)',
      'ocr.tipKey': 'Быстрый совет:',
      'ocr.tipDesc': 'Сделайте скриншот (Win+Shift+S) и нажмите Ctrl+V в любой момент',
      'ocr.detectingFields': 'Извлечение имени, номера, даты рождения и контактов...',
      'ocr.dataExtracted': 'Данные успешно извлечены. Проверьте или измените при необходимости:',
      'ocr.scanAnother': 'Сканировать другой скриншот',
      'ocr.guardianTitle': 'Контакты родителя / опекуна',
      'ocr.guardianRel': 'Родство',
      'ocr.guardianName': 'Имя родителя/опекуна',
      'ocr.guardianPhone': 'Номер телефона',
      'ocr.guardianEmail': 'Email опекуна',
      'ocr.previewNotice': 'Скриншот успешно распознан. Сохраните или откройте анкету для добавления фото.',
      'ocr.continueToForm': 'Перейти в полную анкету',
      'ocr.saveDirect': 'Сохранить игрока',
      'backup.saveBtn': 'Сохранить копию',
      'backup.saveBtnTitle': 'Скачать резервную копию JSON со всеми игроками'
    },
    ...
    uk: {
      ...
      'nav.transport': 'Транспорт',
      'nav.mobile.database': 'Гравці',
      'nav.mobile.teams': 'Команди',
      'nav.mobile.calendar': 'Матчі',
      'nav.mobile.trainings': 'Тренування',
      'nav.mobile.attendance': 'Відвідування',
      'nav.mobile.transport': 'Транспорт',
      ...
      'pos.player': 'Гравець (Без фікс. позиції)',
      'teams.isInitiation': 'Група початкової підготовки / Дитсадок (Психомоторика)',
      'teams.isInitiationHelp': 'Офіційна форма не потрібна. Попередження про екіпірування не відображатимуться.',
      'teams.badgeInitiation': '🐣 Початковий',
      'teams.deleteTeam': '🗑️ Видалити команду',
      'teams.deleteTeamConfirm': 'Ви впевнені, що хочете видалити цю команду? Гравці залишаться без команди.',
      'teams.deleteTeamSuccess': 'Команду успішно видалено',
      'teams.deleteTrainings': '🗑️ Видалити тренування команди',
      'teams.deleteTrainingsConfirm': 'Видалити всі тренування цієї команди?',
      'teams.deleteTrainingsSuccess': 'Тренування команди успішно видалено',
      'teams.noTrainings': 'У цієї команди немає запланованих тренувань',
      'trainings.timeForDay': 'Розклад для',
      'trainings.savedLocations': 'Збережені локації',
      'matches.selectMatchPrompt': 'Оберіть матч',
      'matches.selectMatchHelp': 'Оберіть матч зі списку для перегляду заявки та деталей',
      'transport.selectMatchPrompt': 'Оберіть матч для розподілу пасажирів',
      'attendance.title': 'Облік та Контроль Відвідуваності',
      'attendance.subtitle': 'Загальна статистика команд та детальний звіт по кожному гравцю.',
      'attendance.avgAttendance': 'Середня відвідуваність',
      'attendance.sessionsRatio': 'всього відвідувань',
      'attendance.unfoldPlayers': 'Гравці',
      'attendance.foldPlayers': 'Сховати гравців',
      'attendance.filterPeriod': 'Період',
      'attendance.allSeason': 'Весь сезон',
      'attendance.quickRoster': '📋 Відмітити відвідуваність',
      'attendance.playerRate': 'Відвідуваність:',
      'attendance.sessionsCount': 'тренувань',
      'trainings.manageLocations': '📍 Керування локаціями',
      'trainings.locationsManagerTitle': '📍 Збережені локації та поля',
      'trainings.addNewLocation': '➕ Додати нову локацію',
      'trainings.editLocation': 'Редагувати локацію',
      'trainings.locationName': 'Назва поля / залу',
      'trainings.locationAddress': 'Адреса або місце збору',
      'trainings.confirmDeleteLocation': 'Видалити цю збережену локацію?',
      'trainings.clearAllLocations': 'Очистити все',
      'trainings.resetLocations': 'За замовчуванням',
      'attendance.todayTrainingsTitle': 'Відмітити відвідуваність - Тренування на сьогодні',
      'attendance.noTrainingsToday': 'На сьогодні тренувань не заплановано',
      'attendance.noTrainingsTodayDesc': 'На сьогодні ({date}) тренувальні заняття не заплановані.',
      'attendance.pastPendingAlert': '⚠️ Минулі тренування без відмітки відвідуваності',
      'attendance.pastPendingDesc': 'У вас є минулі тренування, де ще не відмічено відвідуваність:',
      'attendance.badgeDone': '✔ Список відмічено',
      'attendance.badgePending': '⏳ Список не відмічено',
      'attendance.modifyList': '✏️ Змінити список',
      'attendance.takeList': '📋 Відмітити відвідуваність',
      'attendance.takeListNow': '📋 Відмітити зараз',
      'attendance.backToToday': 'Назад до сьогоднішніх тренувань',
      'ocr.importBtn': 'Імпорт зі скріншота',
      'ocr.modalTitle': 'Імпорт гравця зі скріншота',
      'ocr.dropTitle': 'Перетягніть скріншот сюди або натисніть для вибору',
      'ocr.dropSub': 'Сумісно з профілями Sportlyzer та скріншотами з телефону',
      'ocr.chooseFile': 'Вибрати зображення',
      'ocr.pasteClipboard': 'Вставити з буфера (Ctrl+V)',
      'ocr.tipKey': 'Швидка порада:',
      'ocr.tipDesc': 'Зробіть скріншот (Win+Shift+S) і натисніть Ctrl+V у будь-який момент',
      'ocr.detectingFields': 'Вилучення імені, номера, дати народження та контактів...',
      'ocr.dataExtracted': 'Дані успішно вилучено. Перевірте або відредагуйте за потреби:',
      'ocr.scanAnother': 'Сканувати інше зображення',
      'ocr.guardianTitle': 'Контакти батька / матері / опікуна',
      'ocr.guardianRel': 'Спорідненість',
      'ocr.guardianName': "Ім'я опікуна",
      'ocr.guardianPhone': 'Номер телефону',
      'ocr.guardianEmail': 'Email опікуна',
      'ocr.previewNotice': 'Скріншот успішно розпізнано. Збережіть зараз або відкрийте анкету.',
      'ocr.continueToForm': 'Перейти до повної анкети',
      'ocr.saveDirect': 'Зберегти гравця',
      'backup.saveBtn': 'Зберегти копію',
      'backup.saveBtnTitle': 'Завантажити резервну копію JSON з усіма гравцями'
    }
  };
